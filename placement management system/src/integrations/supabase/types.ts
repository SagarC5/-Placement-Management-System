  ...
  public: {
    Tables: {
      ...
      mock_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "mock_results_test_id_fkey"
            columns: ["test_id"]
            isOneToOne: false
      ...
      online_resources: {
        ...
        Relationships: [
          {
            foreignKeyName: "online_resources_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "tpo_jobs"
            referencedColumns: ["id"]
